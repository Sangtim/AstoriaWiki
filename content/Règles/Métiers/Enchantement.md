...
| ---------- | --------------------- | ---------- |
| DC 12      | Essence basique       | /          |
| DC 15      | Essence intermédiaire | /          |
| DC 18      | Essence importante    | /          |
| DC 21      | Essence majeure       | Rare       |
...
| -------------------------------- | -------------------------------------------------------- | ---------- | ------ | ------ |
| Passage à +1 sur un objet 0      | Essence basique + objet + emplacement de sort 1          | DC 14      | 2 jets | -      |
| Passage à +2 sur un objet +1     | Essence intermédiaire + objet +1 + emplacement de sort 2 | DC 17      | 3 jets | -      |
| Passage à +3 sur un objet +2     | Essence importante + objet +2 + emplacement de sort 3    | DC 20      | 4 jets | -      |
| Ajout d'un sort de niveau 1 ou 2 | Essence intermédiaire + objet + parchemin ou sort        | DC 17      | 3 jets | 1d3    |
| Ajout d'un sort de niveau 3 ou 4 | Essence importante + objet +1 + parchemin ou sort        | DC 20      | 4 jets | 1d3    |
| Ajout d'un sort de niveau 5 ou 6 | Essence majeure + objet +2 + parchemin ou sort           | DC 23      | 5 jets | 1      |
| Ajout d'un sort de niveau 7 ou 8 | Essence légendaire + objet +3 + parchemin ou sort        | DC 25      | 6 jets | 1      |
| Ajout d'un sort de niveau 9      | Essence légendaire + objet +3 + parchemin ou sort        | DC 28      | 7 jets | 1      |
...
- **Ingrédients** : Les ingrédients ne sont utilisés que sur le premier jet hormis les emplacements de sorts ou les parchemins ou sorts qui devront être utilisés à chaque jets.
	...
	**Exemple**: je veux enchanter mon épée +2 avec le sort rayon traçant (sort de niveau 2). Je n'ai pas le sort mais j'ai un parchemin. J'utilise le parchemin pour l'intégrer à l'objet sur le premier jet et ensuite sur le deuxième et troisième jet, je pourrais utiliser un emplacement de sort de niveau 2 à la place. 
